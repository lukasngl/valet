...
- **ProviderConfig CRD** — per-namespace credential targeting for multi-tenant clusters (currently all CRDs share the operator's single credential)
- **Additional providers** — AWS IAM, GCP, Keycloak
